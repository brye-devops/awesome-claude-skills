...
- [SAP ECC BAPI Designer](./sap-ecc-bapi-designer/) - Designs and scaffolds standards-compliant SAP ECC BAPIs for Logistics modules (MM/SD/PP), including naming, parameter tables, ABAP function module stubs, and RFC setup.
